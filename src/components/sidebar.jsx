        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Bhavna Walia</a></h1>
              <span className="email"><i className="icon-mail"></i>bhavnawalia1234567@gmail.com</span>
            </div>
